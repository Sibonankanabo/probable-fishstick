...
from magicbox import stop_loss as tpr
...
if joined_data:
    ...
    if st.button("Trade"):
        ...
        # pt.run_backtest(selected_option['login_id'], selected_option['server'], selected_option['password'], selected_option['symbol'])
        # Add your model training code here
        tpr.test_prediction(selected_option['login_id'], selected_option['server'], selected_option['password'], selected_option['symbol'])
